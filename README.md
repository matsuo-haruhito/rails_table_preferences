...
- [Scoped presets](docs/scoped_presets.md): owner, shared, role, and organization scoped presets, default resolution, minimal host-app operating patterns, and admin-side write path examples.
