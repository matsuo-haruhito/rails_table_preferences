...
- [Scoped presets](scoped_presets.md): owner, shared, role, and organization scoped presets, default resolution, minimal operating patterns, and admin-side write path examples.
