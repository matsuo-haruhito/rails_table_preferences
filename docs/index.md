...
- [Header drag reorder](header_drag_reorder.md): column-level `draggable: false` opt-out for headers with host-app interactive content.
...
13. Use `draggable: false` from [Header drag reorder](header_drag_reorder.md) only for columns whose header owns host-app interactive content.
