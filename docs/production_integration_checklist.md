...
4. Repeat the reload after pagination, filtering, or Turbo navigation when the host app uses those paths, and confirm the same stable `table_key` still resolves the preset.
