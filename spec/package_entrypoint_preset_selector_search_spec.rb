...
RSpec.describe "package entrypoint preset selector search source" do
  ...
  it "keeps the public package entrypoints stable" do
    expect(index_source).to include('export { default } from "./controller"')
    expect(index_source).to include('export { default as RailsTablePreferencesController } from "./controller"')
    expect(package_json.dig("exports", "./controller", "default")).to eq("./app/javascript/rails_table_preferences/controller.js")
  end
