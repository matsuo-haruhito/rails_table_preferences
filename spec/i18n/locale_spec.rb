...
RSpec.describe "locale files" do
  ...
  it "provides Japanese editor labels" do
    I18n.with_locale(:ja) do
      ...
      expect(I18n.t("rails_table_preferences.editor.reset")).to eq("テーブル初期設定に戻す")
      expect(I18n.t("rails_table_preferences.editor.reset_hint")).to include("読み込んだ保存済み設定ではなく")
      expect(I18n.t("rails_table_preferences.editor.reset_visible_hint")).to include("保存済み設定へ戻す操作ではありません")
  ...
  it "provides English editor labels" do
    I18n.with_locale(:en) do
      ...
      expect(I18n.t("rails_table_preferences.editor.reset")).to eq("Reset to table defaults")
      expect(I18n.t("rails_table_preferences.editor.reset_hint")).to include("not the loaded preset")
      expect(I18n.t("rails_table_preferences.editor.reset_visible_hint")).to include("does not roll back to the loaded preset")
